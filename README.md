# Basic AntDesign usage with FormFusion

This repository contains a simple example of using a AntDesign component with FormFusion [library](https://www.corelabui.com/).
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/corelabui/basic-antd-usage.git
   ```
